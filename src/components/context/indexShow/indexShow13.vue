...
作者：吴松磊
来源：回形针PaperClip（ID：papercliptv）

这场突然爆发的新型冠状病毒肺炎是如何发生和传播的？死亡率和传播速度有多高？如何降低被感染的可能性？我们会试图回答你我关心的一切问题。
...
根据一份 07 年的论文，咳嗽产生的飞沫核尺寸 82％ 都集中在 0.74-2.12 微米。
...
根据从 1 月 11 日到 1 月 31 日全中国累计确诊和死亡人数的增长曲线。如果我们用总死亡数除以总确诊数，可以得到一个 2% 左右的患病死亡率。
